...
<div class="container col-lg-10">
	...
	<div class="col-lg-12">
		<div class="col-lg-6" style="width: 500px;height: 50px;font-size: 20px;line-height: 50px;background-color: #4F80E7;margin-top: 20px;">平台发布的项目总数：{{ $project_num }}个</div>
	...
	<div class="col-lg-12">
		<div class="col-lg-6" style="width: 500px;height: 50px;font-size: 20px;line-height: 50px;background-color: #82CC51;margin-top: 20px;">回款中的项目总金额：¥{{ $backing_amount }}元</div>
		<div class="col-lg-6" style="width: 500px;height: 50px;font-size: 20px;line-height: 50px;background-color: #F19B85;margin-left: 10px;margin-top: 20px;">转让中项目总金额：¥{{ $transferring_amount }}元</div>
	</div>
</div>
@stop