    ...
    <li style="text-align: center"><a href="#collapse2" style="font-size: 17px" data-toggle="collapse"><span class="glyphicon glyphicon-yen"></span>&nbsp&nbsp投资管理</a></li>
        <div class="collapse in" id="collapse2">
            <ul class="nav">
                ...
                <li style="text-align: center"><a href="#" style="font-size: 16px;color: #FFAC2A;font-weight: bold;">转让中心</a></li>
            </ul>
        </div>
...
<div class="container col-lg-10">
  <h4 style="border-left: 3px solid #FFAC2A;font-size: 20px;margin-top: 22px">&nbsp&nbsp转让中心</h4>
