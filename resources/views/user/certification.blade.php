...
<div class="container col-lg-2" style="border-right: 1px dashed">
	<ul class="nav nav-pills nav-stacked">
		...
		<li style="text-align: center" class="active"><a href="{{ route('certification') }}" style="font-size: 17px"><span class="glyphicon glyphicon-user"></span>&nbsp&nbsp实名认证</a></li>
        ...
        <h4 style="color: #999;margin-top: 20px;">认证时间：{{Auth::user()->get()->certification_time}}</h4>
            ...
            <div class="container col-lg-6" style="margin-top: 20px">
                ...
                <div class="form-group">
                    <label for="real_name" style="width: 80px;">真实姓名：</label>
                    <input type="text" name="real_name" class="form-control" value="{{ old('real_name') }}" required>
                </div>
                <div class="form-group">
                    <label for="ID_card" style="width: 80px;">身份证：</label>
