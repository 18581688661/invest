...
<div class="container col-lg-2" style="border-right: 1px dashed">
	<ul class="nav nav-pills nav-stacked">
        ...
        <div class="collapse in" id="collapse2">
            <ul class="nav">
                ...
                <li style="text-align: center"><a href="{{ route('project_backing') }}" style="font-size: 16px;color: #FFAC2A;font-weight: bold;">回款中项目</a></li>
	...
	<div class="container col-lg-10">
		<h4 style="border-left: 3px solid #FFAC2A;font-size: 20px;margin-top: 22px">&nbsp&nbsp回款中项目</h4>
        	...
        	<table class="table">
                ...
                <div class="md-modal md-effect-17" id="modal-{{ $invest->id }}">
                    <div class="md-content">
                      <h3>项目转让</h3>
                      <div>
                        <form action="{{ route('transfer') }}" method="POST" class="form-horizontal">
                          {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div>注意：实际获得收益将根据实际投资天数计算所得！</div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-success form-control">确定转让</button>
