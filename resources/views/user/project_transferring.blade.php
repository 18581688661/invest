...
<div class="container col-lg-2" style="border-right: 1px dashed">
	<ul class="nav nav-pills nav-stacked">
        ...
        <div class="collapse in" id="collapse2">
            <ul class="nav">
                ...
                <li style="text-align: center"><a href="{{ route('project_transferring') }}" style="font-size: 16px;color: #FFAC2A;font-weight: bold;">转让中项目</a></li>
	...
	<div class="container col-lg-10">
		<h4 style="border-left: 3px solid #FFAC2A;font-size: 20px;margin-top: 22px">&nbsp&nbsp转让中项目</h4>
