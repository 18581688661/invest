...
<div class="container col-lg-2" style="border-right: 1px dashed">
	<ul class="nav nav-pills nav-stacked">
		...
		<li style="text-align: center"><a href="#" style="font-size: 17px"><span class="glyphicon glyphicon-tag"></span>&nbsp&nbsp实名认证</a></li>
        <li style="text-align: center"><a href="#" style="font-size: 17px"><span class="glyphicon glyphicon-tag"></span>&nbsp&nbsp账户安全</a></li>
	</ul>
</div>
	<div class="container col-lg-10">
		<h4 style="border-left: 3px solid #FFAC2A;font-size: 20px;margin-top: 30px">&nbsp&nbsp账户中心</h4>
        ...
        <p style="font-size: 14px;color: #999;margin-top: 20px">上次登录时间：{{Auth::user()->get()->updated_at}}</p>
		<div class="container col-lg-12"style="margin-top: 10px">
			<div class="container col-lg-10" style="font-size: 18px;margin-left: -29px;color:#666;line-height: 34px;">可用余额：¥108827</div>
